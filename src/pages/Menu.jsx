...
const Home = () => {
  ...
  const isFormuleDuJourLoaded = formuleDuJour && Array.isArray(formuleDuJour.Plats);

  const menuOfTheDayData = isFormuleDuJourLoaded ? {
    selectedEntree: formuleDuJour.Plats.filter(plat => plat.Types === "Entrées").map(plat => plat.Nom),
    selectedPlat: formuleDuJour.Plats.filter(plat => plat.Types === "Plats").map(plat => plat.Nom),
    selectedDessert: formuleDuJour.Plats.filter(plat => plat.Types === "Desserts").map(plat => plat.Nom),
